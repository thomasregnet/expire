Feature: Purge
  ...
  Scenario: Purge with rules per cli
    When I run `expire purge backups --keep-most-recent=3`
  ...
  Scenario: Purge with --simulate option
    When I run `expire purge backups --keep-most-recent=3 --simulate`
    Then the following directories should exist:
      | backups/2020-05-25-12-13 |
      | backups/2020-05-24-12-13 |
      | backups/2020-05-23-12-13 |
  ...
  Scenario: Purge with --keep-most-recent=3 per API
    When I call Expire.purge with the keep_most_recent option
    Then the following directories should exist:
      | backups/2020-05-25-12-13 |
      | backups/2020-05-24-12-13 |
      | backups/2020-05-23-12-13 |
  ...
  Scenario: Purge with STDIN
    When I run `sh -c "expire purge - --keep-most-recent=3 < backups.txt"`
    Then the following directories should exist:
      | backups/2020-05-25-12-13 |
      | backups/2020-05-24-12-13 |
      | backups/2020-05-23-12-13 |
